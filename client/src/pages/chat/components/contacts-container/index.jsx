...
import { GET_DM_CONTACTS_ROUTE } from "@/utils/constant";
import { useAppStore } from "@/stores";
import ContactList from "@/components/contact-list.jsx";

const ContactsContainer = () => {
  const { setDirectedMessagesContacts, directedMessagesContacts } = useAppStore();
  ...
  useEffect(() => {
    ...
    getContacts(); // ✅ Call the function
  }, [setDirectedMessagesContacts]);

  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#571908] w-full">
      <div className="pt-3">
        <Logo />
      </div>
      ...
      <div className="my-5">
        ...
        <div className="max-h-[38vh] overflow-y-auto scrollbar-hidden pr-10">
...
const Logo = () => {
  return (
    <div className="flex p-5 justify-start items-center gap-2">
      ...
      <span className="text-3xl font-semibold">ChatEase</span>
    </div>
  );
};
